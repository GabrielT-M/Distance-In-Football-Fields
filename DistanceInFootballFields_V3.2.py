...
# The Football Fields Are American Football Fields
...
# The user needs to enter the name of the standard measurement in plural form.
print("Make sure to enter your measurement in plural form. Miles, kilometers, meters, etc.")
print(" ")

# The user needs to choose one of the compatible measurements they are converting from.
measurement = str(input("Enter your standard measurement. Press enter to continue: "))
print(" ")
...
# The section below takes the user's input of wich measurement they are converting from and changes it to how many are in a football field.
